        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="AjouterReunion.php" >
                            ...
                            <?php
                                ...
                                $req= "select max(Nsession) from session ";
                                $result=mysqli_query($connexion ,$req);
                                $ligne= mysqli_fetch_array($result);
                                $Ses=$ligne['max(Nsession)'];
                                ...
                                if(isset($_POST['submit']))
                                {
                                    ...
                                    { 
                                       ...
                                       $result = mysqli_query($connexion ,"INSERT INTO reunion(idReunion,dateReunion, publique,Nsession) values ('','$date2','$publique' ,'$Ses')");
                                       
                                       {
                                          echo '<script>alert(\'Reunion bien ajoutée.\');</script>';
                                          echo "<script>location.href='AjouterPoint.php';</script>";
                                        }
                                    }
                                }
