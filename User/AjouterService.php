                    ...
                    <div class="card-body">
                        <form method="POST" action="AjouterService.php" >
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label for="intituleService" class="col-form-label">intitule</label>
                                <input id="intituleService"  name="intituleS" type="text" class="form-control" required>
                            </div>
                            ...
                            <?php
                                ...
                                if ($type&&$intitule)
                                { 
                                   $sql = "INSERT INTO service(idService,typeService,intituleService) values ('','$type','$intitule')";
