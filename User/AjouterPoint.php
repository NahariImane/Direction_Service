        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="AjouterPoint.php" >
                        ...
                        <LABEL FOR="Services" class="col-form-label"> Service  : </LABEL>  
                           ...
                           <?php
                                ...
                                $req= "select max(idReunion) from reunion ";
                                $result=mysqli_query($connexion ,$req);
                                $ligne= mysqli_fetch_array($result);
                                $Reu=$ligne['max(idReunion)'];
                                ...
                                { 
                                 ...
                                 $result = mysqli_query($connexion ,"INSERT INTO point(idPoint , intitulePoint , dePachalik ,repporte, raisonRepport , rapport, votePublique , dateEnvoiInt ,nEnvoiInt ,dateEnvoiExt , app_Napp , action , remarques , nEnvoiExt, idService ,idReunion) values ('','$intitulePoint','$Pachalik','$Repporte', '$RaisonRepporte', '$Rapp','$vote', '$dateEI' ,'$NumEnvoiInt' ,'$dateEEx' ,'$NumEnvoiExt' ,'$ap' ,'$action' , '$Rem', '$Service', '$Reu')");
                                    {
                                        echo '<script>alert(\'Point bien ajoutée.\');</script>';
                                        echo "<script>location.href='AfficherPoint.php';</script>";
                                    }
                                }
                                }
