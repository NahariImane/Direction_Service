                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            $intitule=$_POST['RechercheM'];
                                             $requete1="SELECT distinct m.idMembre, m.cin, m.nom, m.prenom, m.partiepolytique FROM membre m where m.cin like '%".$intitule."%' OR m.nom like '%".$intitule."%' OR m.prenom like '%".$intitule."%'";
